...
!------------------------------------------------------------------------------
     ...
     &        nwt,nqg,nrun,nextout,m_fly,nsemble,tblock,tbave,     &
     &        kblock,ccycle,   &
     &        nriver
      real qgmin,                                                        &
     &     aleadfr,snmin,charnock,chn10,zobgin,   &
     ...
     &                nglacier,charnock,chn10,zobgin,ntaft,       &
     ...
     &            nwt,nqg,nrun,nextout,m_fly,tblock,tbave,         &
     &            localhist
