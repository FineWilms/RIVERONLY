...
xp(1:ifull,1) = in   !northern neighbour grid pnt to i
xp(1:ifull,2) = ie    !eastern neighbour grid pnt to i
xp(1:ifull,3) = is    !southern neighbour grid pnt to i
xp(1:ifull,4) = iw   !western neighbour
xp(1:ifull,5) = ine  ! north-eastern neighbour
xp(1:ifull,6) = ise   ! south-eastern neighbour
xp(1:ifull,7) = isw   ! south-western neighbour
xp(1:ifull,8) = inw   ! north-western neighbour
