...
arrays_m.o betts1_m.o cldcom_m.o cfrac_m.o \
dpsdt_m.o epst_m.o extraout_m.o histave_m.o kdacom_m.o \
liqwpar_m.o lwout_m.o morepbl_m.o nlin_m.o \
...
workglob_m.o work2_m.o work3_m.o work3b_m.o work3lwr_m.o \
xarrs_m.o \
...
timeseries.o : arrays_m.o cable_define_types.o cc_mpi.o infile.o extraout_m.o morepbl_m.o pbl_m.o prec_m.o sigs_m.o soil_m.o soilsnow_m.o vecsuv_m.o vegpar_m.o vvel_m.o xyzinfo_m.o const_phys.h dates.h newmpar.h parmgeom.h
