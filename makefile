...
uvbar_m.o workglob_m.o work2_m.o work3_m.o work3b_m.o \
...
onthefly.o : cc_mpi.o cable_define_types.o diag_m.o extraout_m.o infile.o latlong_m.o morepbl_m.o nsibd_m.o river.o savuvt_m.o savuv1_m.o sigs_m.o soil_m.o utilities.o vecsuv_m.o workglob_m.o work2_m.o xarrs_m.o const_phys.h darcdf.h kuocom.h newmpar.h parm.h parmdyn.h parmgeom.h soilv.h stime.h
outcdf.o : arrays_m.o cable_ccam2.o cable_define_types.o cc_mpi.o extraout_m.o histave_m.o infile.o latlong_m.o map_m.o morepbl_m.o nsibd_m.o parmhdff_m.o pbl_m.o prec_m.o river.o savuvt_m.o savuv1_m.o sigs_m.o soil_m.o soilsnow_m.o work2_m.o xarrs_m.o const_phys.h dates.h filnames.h kuocom.h newmpar.h parm.h parmdyn.h parmgeom.h parmhor.h parmsurf.h soilv.h version.h
...
sflux.o : arrays_m.o cable_ccam2.o cc_mpi.o diag_m.o extraout_m.o latlong_m.o map_m.o morepbl_m.o nsibd_m.o pbl_m.o permsurf_m.o prec_m.o river.o savuvt_m.o sigs_m.o soil_m.o soilsnow_m.o vecsuv_m.o work2_m.o work3_m.o xyzinfo_m.o const_phys.h dates.h newmpar.h parm.h parmgeom.h parmsurf.h soilv.h
